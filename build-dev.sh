...
mvn clean install --threads 2C -DskipTests -Dmaven.test.skip=true -f "${DIR}/pom.xml" -pl -d2fsam-web-embedded-server,-d2fsam-test-integration,-am-test-coverage
#mvn clean install --threads 2C -DskipTests -Dmaven.test.skip=true -f "${DIR}/am-web/pom.xml"
#mvn -DskipTests -Dmaven.test.skip=true -f "${DIR}/am-web/am-web-portal/pom.xml" jib:dockerBuild
