...
@Slf4j
public class SingleSetupIntegrationTestExecutionListener extends AbstractTestExecutionListener {
    ...
    public void beforeTestClass(TestContext testContext) throws Exception {
        ...
        SingleSetupIntegrationTestExecutionListener.currentTransactionContext.set(txContext);
    }

    @Override
    public void afterTestClass(TestContext testContext) throws Exception {
        log.info("Rollback Transaction - afterTestClass");
        MyTransactionContext txContext = SingleSetupIntegrationTestExecutionListener.currentTransactionContext.get();
