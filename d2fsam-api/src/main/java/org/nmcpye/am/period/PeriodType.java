...
import org.nmcpye.am.cache.SimpleCacheBuilder;
import org.nmcpye.am.calendar.*;
...
public abstract class PeriodType implements Serializable {
    ...
    private static org.nmcpye.am.cache.Cache<Period> PERIOD_CACHE = new SimpleCacheBuilder<Period>()
    ...
    public static org.nmcpye.am.calendar.Calendar getCalendar() {
     ...
     */
    public static List<Period> getPeriodTypePeriods(Period period, org.nmcpye.am.calendar.Calendar calendar) {
     ...
     * @return a period.
     */
    public static Period getPeriodByPeriodType(Period period, PeriodType periodType, org.nmcpye.am.calendar.Calendar calendar) {
    ...
    public static Calendar createCalendarInstance() {
        org.nmcpye.am.calendar.Calendar cal = getCalendar();
     ...
     * @return an instance of a Calendar without any time of day.
     */
    public static DateTimeUnit createLocalDateUnitInstance(Date date, org.nmcpye.am.calendar.Calendar calendar) {
    ...
    private String getCacheKey(org.nmcpye.am.calendar.Calendar calendar, Date date) {
    ...
    public Period createPeriod(Calendar cal) {
        org.nmcpye.am.calendar.Calendar calendar = getCalendar();
     ...
     * @return the valid Period based on the given date
     */
    public Period createPeriod(final Date date, final org.nmcpye.am.calendar.Calendar calendar) {
    ...
    protected Period toIsoPeriod(DateTimeUnit start, DateTimeUnit end, org.nmcpye.am.calendar.Calendar calendar) {
        DateTimeUnit from = calendar.toIso(start);
        DateTimeUnit to = calendar.toIso(end);

        return new Period(this, from.toJdkDate(),
            to.toJdkDate(), getIsoDate(start, calendar));
    }
    ...
    public abstract Period createPeriod(DateTimeUnit dateTimeUnit, org.nmcpye.am.calendar.Calendar calendar);
     ...
     * @return the period as string
     */
    public abstract String getIsoDate(DateTimeUnit dateTimeUnit, org.nmcpye.am.calendar.Calendar calendar);
     ...
     * @return a Period which is the next of the given Period.
     */
    public Period getNextPeriod(Period period, org.nmcpye.am.calendar.Calendar calendar) {
     ...
     * @return a Period which is the previous of the given Period.
     */
    public Period getPreviousPeriod(Period period, org.nmcpye.am.calendar.Calendar calendar) {
        DateTimeUnit dateWithOffset = getDateWithOffset(
            createLocalDateUnitInstance(period.getStartDate(), calendar),
            -1,
            calendar
     ...
     */
    protected abstract DateTimeUnit getDateWithOffset(DateTimeUnit dateTimeUnit, int offset, org.nmcpye.am.calendar.Calendar calendar);
