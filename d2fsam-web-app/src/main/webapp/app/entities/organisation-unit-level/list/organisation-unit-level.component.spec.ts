...
describe('OrganisationUnitLevel Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'organisation-unit-level', component: OrganisationUnitLevelComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to organisationUnitLevelService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOrganisationUnitLevelIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOrganisationUnitLevelIdentifier).toHaveBeenCalledWith(entity);
