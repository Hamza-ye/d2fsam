...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../file-resource.test-samples';

import { FileResourceService, RestFileResource } from './file-resource.service';

const requireRestSample: RestFileResource = {
...
describe('FileResource Service', () => {
  ...
  describe('Service methods', () => {
    ...
    it('should create a FileResource', () => {
      ...
      const fileResource = { ...sampleWithNewData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.create(fileResource).subscribe(resp => (expectedResult = resp.body));
    ...
    it('should update a FileResource', () => {
      const fileResource = { ...sampleWithRequiredData };
      const returnedFromService = { ...requireRestSample };
      const expected = { ...sampleWithRequiredData };

      service.update(fileResource).subscribe(resp => (expectedResult = resp.body));
    ...
    describe('addFileResourceToCollectionIfMissing', () => {
      it('should add a FileResource to an empty array', () => {
        const fileResource: IFileResource = sampleWithRequiredData;
      ...
      it("should add a FileResource to an array that doesn't contain it", () => {
        const fileResource: IFileResource = sampleWithRequiredData;
        const fileResourceCollection: IFileResource[] = [sampleWithPartialData];
        expectedResult = service.addFileResourceToCollectionIfMissing(fileResourceCollection, fileResource);
        expect(expectedResult).toHaveLength(2);
        expect(expectedResult).toContain(fileResource);
      });
      ...
      it('should add only unique FileResource to an array', () => {
        const fileResourceArray: IFileResource[] = [sampleWithRequiredData, sampleWithPartialData, sampleWithFullData];
        const fileResourceCollection: IFileResource[] = [sampleWithRequiredData];
      ...
      it('should accept varargs', () => {
        const fileResource: IFileResource = sampleWithRequiredData;
        const fileResource2: IFileResource = sampleWithPartialData;
    ...
    describe('compareFileResource', () => {
      it('Should return true if both entities are null', () => {
        ...
        const compareResult = service.compareFileResource(entity1, entity2);
      ...
      it('Should return false if one entity is null', () => {
        ...
        const compareResult1 = service.compareFileResource(entity1, entity2);
        const compareResult2 = service.compareFileResource(entity2, entity1);
