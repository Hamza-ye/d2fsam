...
import { sampleWithRequiredData, sampleWithNewData, sampleWithPartialData, sampleWithFullData } from '../user-data.test-samples';

import { UserDataService, RestUserData } from './user-data.service';

const requireRestSample: RestUserData = {
