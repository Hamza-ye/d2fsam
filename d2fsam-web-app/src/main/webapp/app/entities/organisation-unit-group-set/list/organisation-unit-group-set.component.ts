...
import { EntityArrayResponseType, OrganisationUnitGroupSetService } from '../service/organisation-unit-group-set.service';
...
export class OrganisationUnitGroupSetComponent implements OnInit {
  ...
  trackId = (_index: number, item: IOrganisationUnitGroupSet): number =>
    this.organisationUnitGroupSetService.getOrganisationUnitGroupSetIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.organisationUnitGroupSets = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IOrganisationUnitGroupSet[] | null): IOrganisationUnitGroupSet[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.organisationUnitGroupSetService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
