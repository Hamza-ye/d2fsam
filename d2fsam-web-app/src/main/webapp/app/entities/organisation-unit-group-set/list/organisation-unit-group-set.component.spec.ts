...
describe('OrganisationUnitGroupSet Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'organisation-unit-group-set', component: OrganisationUnitGroupSetComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to organisationUnitGroupSetService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOrganisationUnitGroupSetIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOrganisationUnitGroupSetIdentifier).toHaveBeenCalledWith(entity);
