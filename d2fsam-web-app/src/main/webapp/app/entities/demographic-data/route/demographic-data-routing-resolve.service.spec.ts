...
describe('DemographicData routing resolve service', () => {
  ...
  let resultDemographicData: IDemographicData | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultDemographicData).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IDemographicData>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
