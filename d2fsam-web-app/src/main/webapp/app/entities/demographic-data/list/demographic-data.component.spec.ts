...
describe('DemographicData Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'demographic-data', component: DemographicDataComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to demographicDataService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getDemographicDataIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getDemographicDataIdentifier).toHaveBeenCalledWith(entity);
