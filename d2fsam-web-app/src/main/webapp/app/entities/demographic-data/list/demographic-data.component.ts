...
import { EntityArrayResponseType, DemographicDataService } from '../service/demographic-data.service';
...
export class DemographicDataComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDemographicData): number => this.demographicDataService.getDemographicDataIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.demographicData = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IDemographicData[] | null): IDemographicData[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.demographicDataService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
