...
describe('RelationshipType routing resolve service', () => {
  ...
  let resultRelationshipType: IRelationshipType | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultRelationshipType).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IRelationshipType>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
