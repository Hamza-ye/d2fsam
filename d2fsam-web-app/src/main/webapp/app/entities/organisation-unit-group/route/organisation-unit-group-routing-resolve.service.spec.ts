...
describe('OrganisationUnitGroup routing resolve service', () => {
  ...
  let resultOrganisationUnitGroup: IOrganisationUnitGroup | null | undefined;
  ...
  describe('resolve', () => {
    ...
    it('should return null if id is not provided', () => {
      ...
      expect(resultOrganisationUnitGroup).toEqual(null);
    });

    it('should route to 404 page if data not found in server', () => {
      // GIVEN
      jest.spyOn(service, 'find').mockReturnValue(of(new HttpResponse<IOrganisationUnitGroup>({ body: null })));
      mockActivatedRouteSnapshot.params = { id: 123 };
