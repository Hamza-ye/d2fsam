...
import { EntityArrayResponseType, OrganisationUnitGroupService } from '../service/organisation-unit-group.service';
...
export class OrganisationUnitGroupComponent implements OnInit {
  ...
  trackId = (_index: number, item: IOrganisationUnitGroup): number =>
    this.organisationUnitGroupService.getOrganisationUnitGroupIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.organisationUnitGroups = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IOrganisationUnitGroup[] | null): IOrganisationUnitGroup[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.organisationUnitGroupService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
