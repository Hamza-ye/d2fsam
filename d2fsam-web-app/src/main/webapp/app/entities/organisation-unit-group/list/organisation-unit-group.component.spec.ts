...
describe('OrganisationUnitGroup Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [
        RouterTestingModule.withRoutes([{ path: 'organisation-unit-group', component: OrganisationUnitGroupComponent }]),
  ...
  describe('trackId', () => {
    it('Should forward to organisationUnitGroupService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getOrganisationUnitGroupIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getOrganisationUnitGroupIdentifier).toHaveBeenCalledWith(entity);
