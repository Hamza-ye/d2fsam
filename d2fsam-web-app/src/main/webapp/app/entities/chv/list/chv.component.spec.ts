...
describe('Chv Management Component', () => {
  ...
  beforeEach(() => {
    TestBed.configureTestingModule({
      imports: [RouterTestingModule.withRoutes([{ path: 'chv', component: ChvComponent }]), HttpClientTestingModule],
  ...
  describe('trackId', () => {
    it('Should forward to chvService', () => {
      const entity = { id: 123 };
      jest.spyOn(service, 'getChvIdentifier');
      const id = comp.trackId(0, entity);
      expect(service.getChvIdentifier).toHaveBeenCalledWith(entity);
