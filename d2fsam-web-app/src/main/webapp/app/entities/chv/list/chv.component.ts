...
import { EntityArrayResponseType, ChvService } from '../service/chv.service';
...
export class ChvComponent implements OnInit {
  ...
  trackId = (_index: number, item: IChv): number => this.chvService.getChvIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.chvs = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IChv[] | null): IChv[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.chvService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
