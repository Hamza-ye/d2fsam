...
describe('OptionSet Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call User query and add missing value', () => {
      const optionSet: IOptionSet = { id: 456 };
      const createdBy: IUser = { id: 59458 };
      optionSet.createdBy = createdBy;
      const updatedBy: IUser = { id: 76181 };
      optionSet.updatedBy = updatedBy;

      const userCollection: IUser[] = [{ id: 74373 }];
    ...
    it('Should update editForm', () => {
      const optionSet: IOptionSet = { id: 456 };
      const createdBy: IUser = { id: 27410 };
      optionSet.createdBy = createdBy;
      const updatedBy: IUser = { id: 72919 };
      optionSet.updatedBy = updatedBy;
