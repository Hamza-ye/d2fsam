...
import { EntityArrayResponseType, DemographicDataSourceService } from '../service/demographic-data-source.service';
...
export class DemographicDataSourceComponent implements OnInit {
  ...
  trackId = (_index: number, item: IDemographicDataSource): number =>
    this.demographicDataSourceService.getDemographicDataSourceIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.demographicDataSources = dataFromBody;
  }

  protected fillComponentAttributesFromResponseBody(data: IDemographicDataSource[] | null): IDemographicDataSource[] {
    return data ?? [];
  }
  ...
  protected queryBackend(page?: number, predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.demographicDataSourceService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
